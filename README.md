...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kkghlyq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kkghlyq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Partha727/container-kkghlyq.git
cd container-kkghlyq
```
...
```
docker attach container-kkghlyq
```
